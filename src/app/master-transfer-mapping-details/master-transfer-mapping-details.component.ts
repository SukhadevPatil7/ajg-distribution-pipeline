...
@Component({
  selector: 'app-master-transfer-mapping-details',
  templateUrl: './master-transfer-mapping-details.component.html',
  styleUrls: ['./master-transfer-mapping-details.component.css']
})
export class MasterTransferMappingDetailsComponent implements OnInit {
  ...
  editMTTMapping(row : any)
  {
    this.dialog.open(MasterTransferMappingComponent,{
      width:'30%',
      data:[row,'edit']
    }
  ...
  openConfirmDialog(enterAnimationDuration: string, exitAnimationDuration: string,masterTransferIdId:any,transferId : any): void {
    this.dialog.open(ConfirmDialogComponent, {
    ...
    }).afterClosed().subscribe(val=>{
      {
        ...
        {
          this.deleteMasterTransferMappings(masterTransferIdId,transferId);
        }
      }
    });
  }
  ...
  deleteMasterTransferMappings(masterTransferIdId: number,transferId  : number){
    this.api.deleteMasterTransferMappings(masterTransferIdId,transferId)
    .subscribe({
        next:(res)=>
        {
